...
const Header = ({changeToWhiteBg, isLoggedIn,className}) => {
  return (
    !isLoggedIn ? (<div className={`w-full  py-4  border-b border-black px-4 fixed ${changeToWhiteBg ? 'bg-white' : 'bg-[#FFC017]'} ease-in duration-500 ${className}`}>
